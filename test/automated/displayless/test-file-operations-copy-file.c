...
test_copy_full_directory_one_child (void)
{
    ...
    /* We'll clean up the hierarchy. It looks like this now:
     * /first_dir/dir_to_copy
     * /second_dir/dir_to_copy/dir_to_copy
     */
...
test_copy_full_directory_two_children (void)
{
    ...
    g_assert_true (file != NULL);
    g_file_make_directory (file, NULL, NULL);
    file = g_file_get_child (first_dir, "second_dir_to_copy");
    g_assert_true (file != NULL);
    g_file_make_directory (file, NULL, NULL);
