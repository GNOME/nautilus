                              ...
                              GParamSpec   *pspec)
{
    ...
    switch (param_id)
    {
        ...
        case PROP_ATTRIBUTE:
        {
            ...
            g_object_notify_by_pspec (object, properties[PROP_ATTRIBUTE]);
            g_object_notify_by_pspec (object, properties[PROP_ATTRIBUTE_Q]);
        }
        break;
...
nautilus_column_class_init (NautilusColumnClass *class)
{
     ...
     */
    properties[PROP_DEFAULT_SORT_ORDER] =
