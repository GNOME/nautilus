                                 ...
                                 gpointer      callback_data)
{
    ...
    RecentInfoUpdateData *recent_data = callback_data;
    ...
    g_free (recent_data->old_uri);
    g_free (recent_data->new_uri);
    g_free (recent_data->old_display_name);
    g_free (recent_data->new_display_name);
    g_free (recent_data);
}
                                         ...
                                         NautilusFileOperation *op)
{
    ...
    else
    {
        ...
        recent_data->op = op;
        recent_data->old_uri = g_strdup (old_uri);
        recent_data->new_uri = g_strdup (new_uri);
        recent_data->old_display_name = g_strdup (old_display_name);
        recent_data->new_display_name = g_strdup (new_display_name);
