         ...
         int            *natural_baseline)
{
    ...
    eel_canvas_w2c (canvas, x1, y1, &bounds.x, &bounds.y);
    eel_canvas_w2c (canvas, x2, y2, &bounds.width, &bounds.height);
                                   ...
                                   gpointer                  user_data)
{
    ...
    eel_canvas_window_to_world (EEL_CANVAS (container), x, y, &world_x, &world_y);
    ...
    nautilus_canvas_dnd_begin_drag (container, actions, canvas_x, canvas_y);
                            ...
                            gpointer        user_data)
{
    ...
    start_x += gtk_adjustment_get_value (hadjustment);
    start_y += gtk_adjustment_get_value (vadjustment);
                            ...
                            EelEvent                *event)
{
    ...
    /* FIXME: only GDK_BUTTON_PRESS remains. */
#if 0
