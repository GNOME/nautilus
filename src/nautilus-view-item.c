                               ...
                               gboolean          prioritize)
{
    ...
    if (prioritize)
    {
        ...
        if (idle_prioriritze == 0)
        {
            idle_prioriritze = g_timeout_add_once (5, prioritize_idle_callback, NULL);
        }
    }
    else
    {
