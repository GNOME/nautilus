...
gboolean nautilus_view_setup_cell_once (NautilusViewCell *self,
...
void nautilus_view_cell_unbind_common (NautilusViewCell *self,
                                       GtkListItem      *listitem);
void nautilus_view_cell_bind_common (NautilusViewCell *self,
                                     GtkListItem      *listitem);
