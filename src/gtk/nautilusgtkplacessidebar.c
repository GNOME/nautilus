           ...
           const gchar                 *tooltip)
{
  ...
  row = g_object_new (NAUTILUS_GTK_TYPE_SIDEBAR_ROW,
                      "sidebar", sidebar,
  ...
  g_signal_connect (NAUTILUS_GTK_SIDEBAR_ROW (row), "button-press-event",
                    G_CALLBACK (on_button_press_event), row);
  g_signal_connect (NAUTILUS_GTK_SIDEBAR_ROW (row), "button-release-event",
                  ...
                  GtkWidget          *cloud_row)
{
  ...
  nautilus_gtk_sidebar_row_set_end_icon (NAUTILUS_GTK_SIDEBAR_ROW (cloud_row), end_icon);
  if (end_icon != NULL)
                   ...
                   gpointer   user_data)
{
  ...
  g_object_get (NAUTILUS_GTK_SIDEBAR_ROW (object), "cloud-provider", &cloud_provider_account, NULL);
