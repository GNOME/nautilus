...
#define NAUTILUS_GTK_TYPE_SIDEBAR_ROW             (nautilus_gtk_sidebar_row_get_type())
#define NAUTILUS_GTK_SIDEBAR_ROW(obj)             (G_TYPE_CHECK_INSTANCE_CAST ((obj), NAUTILUS_GTK_TYPE_SIDEBAR_ROW, NautilusGtkSidebarRow))
#define NAUTILUS_GTK_SIDEBAR_ROW_CLASS(klass)     (G_TYPE_CHECK_CLASS_CAST ((klass), NAUTILUS_GTK_TYPE_SIDEBAR_ROW, NautilusGtkSidebarRowClass))
#define NAUTILUS_GTK_IS_SIDEBAR_ROW(obj)          (G_TYPE_CHECK_INSTANCE_TYPE ((obj), NAUTILUS_GTK_TYPE_SIDEBAR_ROW))
#define NAUTILUS_GTK_IS_SIDEBAR_ROW_CLASS(klass)  (G_TYPE_CHECK_CLASS_TYPE ((klass), NAUTILUS_GTK_TYPE_SIDEBAR_ROW))
#define NAUTILUS_GTK_SIDEBAR_ROW_GET_CLASS(obj)   (G_TYPE_INSTANCE_GET_CLASS ((obj), NAUTILUS_GTK_TYPE_SIDEBAR_ROW, NautilusGtkSidebarRowClass))
