                 ...
                 gpointer       user_data)
{
    ...
    /* if the XDG Templates directory is empty */
...
add_directory_to_templates_directory_list (NautilusFilesView *self)
{
    ...
    NautilusDirectory *templates_directory = nautilus_directory_get_by_uri (templates_uri);

    add_directory_to_directory_list (self, templates_directory,
...
remove_directory_from_templates_directory_list (NautilusFilesView *self)
{
    ...
    {
        next = node->next;
        remove_directory_from_directory_list (self, node->data,
                                              &self->templates_directory_list,
                                              G_CALLBACK (templates_changed_cb));
    }
}
...
nautilus_files_view_dispose (GObject *object)
{
    ...
    remove_directory_from_templates_directory_list (self);
...
nautilus_files_view_init (NautilusFilesView *self)
{
    ...
    if (nautilus_should_use_templates_directory ())
    {
        ...
        add_directory_to_templates_directory_list (self);
    }
