...
static void nautilus_file_operations_move_final (CopyMoveJob *job);
                       ...
                       GCancellable *cancellable)
{
    ...
    nautilus_file_operations_move_final (job);
}
                                    ...
                                    gpointer              done_callback_data)
{
    ...
    g_task_set_task_data (task, job, NULL);
    g_task_run_in_thread_sync (task, move_task_thread_func);
    g_object_unref (task);
}

static void
nautilus_file_operations_move_final (CopyMoveJob *job)
{
    CommonJob *common;
    GList *fallbacks;
    SourceInfo source_info;
