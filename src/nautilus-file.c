...
static char *nautilus_file_get_type_as_string_no_link_to (NautilusFile *file);
                 ...
                 NautilusFile *file_2)
{
    ...
    type_string_1 = nautilus_file_get_type_as_string_no_link_to (file_1);
    type_string_2 = nautilus_file_get_type_as_string_no_link_to (file_2);
...
static char *
nautilus_file_get_type_as_string_no_link_to (NautilusFile *file)
{
    if (file == NULL)
    {
        return NULL;
