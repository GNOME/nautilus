...
static gboolean
handle_trash_uris (NautilusDBusFileOperations2  *object,
                   GDBusMethodInvocation        *invocation,
                   const gchar                 **uris,
                   GVariant                     *platform_data)
{
...
static gboolean
handle_delete_uris (NautilusDBusFileOperations2  *object,
                    GDBusMethodInvocation        *invocation,
                    const gchar                 **uris,
                    GVariant                     *platform_data)
{
...
static gboolean
handle_rename_uri (NautilusDBusFileOperations2 *object,
                   GDBusMethodInvocation       *invocation,
                   const gchar                 *uri,
                   const gchar                 *new_name,
                   GVariant                    *platform_data)
...
nautilus_dbus_manager_init (NautilusDBusManager *self)
{
    ...
    g_signal_connect (self->file_operations2,
                      "handle-trash-uris",
                      G_CALLBACK (handle_trash_uris),
                      self);
    g_signal_connect (self->file_operations2,
                      "handle-delete-uris",
                      G_CALLBACK (handle_delete_uris),
                      self);
    g_signal_connect (self->file_operations,
