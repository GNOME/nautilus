...
static void
redo (NautilusFileOperationsDBusData *dbus_data)
{
    NautilusFileUndoManager *undo_manager = NULL;
...
static void
undo (NautilusFileOperationsDBusData *dbus_data)
{
    NautilusFileUndoManager *undo_manager = NULL;
    gint *handler_id = g_new0(int, 1);
...
{
    copy_uris (sources, destination, NULL);
                   ...
                   GVariant                     *platform_data)
{
    ...
    copy_uris (sources, destination, dbus_data);
    nautilus_file_operations_dbus_data_unref (dbus_data);
...
handle_move_uris (NautilusDBusFileOperations  *object,
                  ...
                  const gchar                 *destination)
{
    move_uris (sources, destination, NULL);
                   ...
                   GVariant                     *platform_data)
{
    ...
    move_uris (sources, destination, dbus_data);
    nautilus_file_operations_dbus_data_unref (dbus_data);
...
static void
empty_trash (NautilusFileOperationsDBusData *dbus_data)
{
                      ...
                      GVariant                     *platform_data)
{
    ...
    delete_files (sources, dbus_data);
    nautilus_file_operations_dbus_data_unref (dbus_data);
                     ...
                     GVariant                    *platform_data)
{
    ...
    rename_file (uri, new_name, dbus_data);
    nautilus_file_operations_dbus_data_unref (dbus_data);
