                           ...
                           GtkGrid                  *page_grid)
{
    ...
    if (!is_multi_file_window (window) && nautilus_file_can_set_owner (get_target_file (window)))
    {
        ...
        gtk_widget_show (window->owner_label);
        gtk_widget_show (window->owner_value_stack);
    ...
    if (has_directory && has_file)
    {
        ...
        setup_permissions_combo_box (window, GTK_COMBO_BOX (window->owner_folder_access_combo),
        ...
        setup_permissions_combo_box (window, GTK_COMBO_BOX (window->owner_file_access_combo),
    ...
    else
    {
        ...
        setup_permissions_combo_box (window, GTK_COMBO_BOX (window->owner_access_combo),
    ...
    {
        /* Combo box in this case. */
        gtk_widget_show (window->group_label);
        gtk_widget_show (window->group_value_stack);
    ...
    if (has_directory && has_file)
    {
        gtk_widget_show (window->others_label);
...
nautilus_properties_window_class_init (NautilusPropertiesWindowClass *klass)
{
    ...
    gtk_widget_class_bind_template_child (widget_class, NautilusPropertiesWindow, group_label);
    ...
    gtk_widget_class_bind_template_child (widget_class, NautilusPropertiesWindow, others_label);
