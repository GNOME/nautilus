                           ...
                           GtkGrid                  *page_grid)
{
    ...
    {
        owner_label = gtk_stack_get_child_by_name (GTK_STACK (window->owner_label_stack),"mnemonic_label");
        gtk_stack_set_visible_child (GTK_STACK (window->owner_label_stack), owner_label);
        /* Combo box in this case. */
        setup_owner_combo_box (window, get_target_file (window));
    }
    else
    {
        owner_label = gtk_stack_get_child_by_name (GTK_STACK (window->owner_label_stack),"plain_label");
        gtk_stack_set_visible_child (GTK_STACK (window->owner_label_stack), owner_label);
...
nautilus_properties_window_class_init (NautilusPropertiesWindowClass *klass)
{
    ...
    gtk_widget_class_bind_template_child (widget_class, NautilusPropertiesWindow, owner_label_stack);
