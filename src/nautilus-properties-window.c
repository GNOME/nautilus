                           ...
                           GtkGrid                  *page_grid)
{
    ...
    if (!is_multi_file_window (window) && nautilus_file_can_set_owner (get_target_file (window)))
    {
        ...
        owner_combo_box = setup_owner_combo_box (window, get_target_file (window));
        gtk_label_set_mnemonic_widget (GTK_LABEL (window->owner_label), GTK_WIDGET (owner_combo_box));
    }
    else
    {
        ...
        gtk_label_set_mnemonic_widget (GTK_LABEL (window->owner_label), value);
