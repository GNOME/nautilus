...
static gboolean
window_on_delete_event (GtkWidget *widget,
                        GdkEvent  *event,
                        gpointer   user_data)
{
                             ...
                             gpointer      data)
{
    ...
    if (g_hash_table_size (startup_data->pending_files) == 0)
    {
        ...
        g_signal_connect(GTK_WIDGET (new_window), "delete-event",
                         G_CALLBACK (window_on_delete_event), startup_data);
    }
}
                                    ...
                                    gpointer                          callback_data)
{
    ...
    if (existing_window != NULL)
    {
        ...
        g_signal_connect(GTK_WIDGET (existing_window), "delete-event",
                         G_CALLBACK (window_on_delete_event), startup_data);
        return;
    }
