                                         ...
                                         GtkWindow    *parent_window)
{
    ...
    show_custom_dialog (_("This location could not be displayed."),
                        message,
                        parent_window,
                        GTK_MESSAGE_ERROR);
}
                                     ...
                                     GtkWindow    *parent_window)
{
    ...
    show_custom_dialog (_("The group could not be changed."),
                        message,
                        parent_window,
                        GTK_MESSAGE_ERROR);
}
                                     ...
                                     GtkWindow    *parent_window)
{
    ...
    show_custom_dialog (_("The owner could not be changed."),
                        message,
                        parent_window,
                        GTK_MESSAGE_ERROR);
}
                                           ...
                                           GtkWindow    *parent_window)
{
    ...
    show_custom_dialog (_("The permissions could not be changed."),
                        message,
                        parent_window,
                        GTK_MESSAGE_ERROR);
}
                                     ...
                                     GtkWindow    *parent_window)
{
    ...
    show_custom_dialog (_("The item could not be renamed."),
                        message,
                        parent_window,
                        GTK_MESSAGE_ERROR);
}
