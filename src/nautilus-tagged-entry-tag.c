               ...
               int                  baseline)
{
    ...
    label_allocation.y = (allocation->height - label_allocation.height) / 2;
    ...
    image_allocation.y = (allocation->height - image_allocation.height) / 2;
