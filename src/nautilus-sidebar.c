                         ...
                         int              position)
{
    ...
    for (l = files; l; l = l->next)
    {
        ...
        if (info)
        {
            ...
            {
                nautilus_bookmark_list_insert (sidebar->bookmark_list, f, position++);
            }
           ...
           NautilusSidebar *sidebar)
{
    ...
    NautilusBookmark *bookmark = nautilus_bookmark_list_get_bookmark (sidebar->bookmark_list, file);
