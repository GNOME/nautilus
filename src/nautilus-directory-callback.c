...
static void
nautilus_directory_callback_add (NautilusDirectory         *directory,
                                 NautilusFile              *file,
                                 Request                    request,
                                             ...
                                             gpointer                   callback_data)
{
    ...
    nautilus_directory_callback_add (directory, file, request, directory_callback, file_callback, callback_data);
