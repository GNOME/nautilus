...
static void set_view_mode (NautilusWindowSlot *self,
                           guint view_id);
...
use_experimental_views_changed_callback (gpointer callback_data)
{
    ...
    else if (view_id == NAUTILUS_VIEW_CANVAS_ID)
    {
        change_files_view_mode (self, NAUTILUS_VIEW_ICON_CONTROLLER_ID);
    }
}
...
static void
set_view_mode (NautilusWindowSlot *self,
               guint view_id)
{
    if (view_id == NAUTILUS_VIEW_CANVAS_ID ||
                               ...
                               gpointer       user_data)
{
    ...
    if (current_view_id == NAUTILUS_VIEW_CANVAS_ID ||
        current_view_id == NAUTILUS_VIEW_ICON_CONTROLLER_ID)
    {
        set_view_mode (self, NAUTILUS_VIEW_LIST_ID);
    }
    else if (current_view_id == NAUTILUS_VIEW_LIST_ID)
    {
        set_view_mode (self, NAUTILUS_VIEW_CANVAS_ID);
    }
}
...
const GActionEntry slot_entries[] =
{
    ...
    { "files-view-mode", NULL, "u", "uint32 5", files_view_mode },
