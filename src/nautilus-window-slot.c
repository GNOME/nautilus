...
/* Whenever we need to use nautilus_window_slot_content_view(),
 * we should check for nautilus_window_slot_content_view_matches()
 * before, as we'd otherwise switch to the current view.
 */
