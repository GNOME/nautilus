...
#ifndef NAUTILUS_LINK_IMPL_H
#define NAUTILUS_LINK_IMPL_H
...
gboolean         nautilus_link_impl_local_create                     (const char        *directory_path,
								      const char        *name,
								      const char        *image,
								      const char        *target_uri,
								      const GdkPoint    *point,
								      NautilusLinkType   type);
gboolean         nautilus_link_impl_local_set_icon                   (const char        *path,
								      const char        *icon_name);
gboolean         nautilus_link_impl_local_set_type                   (const char        *path,
								      NautilusLinkType   type);
