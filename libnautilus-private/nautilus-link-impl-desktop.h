...
#ifndef NAUTILUS_LINK_IMPL_DESKTOP_H
#define NAUTILUS_LINK_IMPL_DESKTOP_H
...
gboolean         nautilus_link_impl_desktop_local_create                     (const char        *directory_path,
									      const char        *name,
									      const char        *image,
									      const char        *target_uri,
									      const GdkPoint    *point,
									      NautilusLinkType   type);
gboolean         nautilus_link_impl_desktop_local_set_icon                   (const char        *path,
									      const char        *icon_name);
gboolean         nautilus_link_impl_desktop_local_set_type                   (const char        *path,
									      NautilusLinkType   type);
gboolean         nautilus_link_impl_desktop_local_set_link_uri               (const char        *path,
									      const char        *uri);
...
gboolean         nautilus_link_impl_desktop_local_is_trash_link              (const char        *path);
...
#endif /* NAUTILUS_LINK_IMPL_DESKTOP_H */
