...
gboolean
nautilus_link_impl_local_create (const char       *directory_path,
				 const char       *name,
				 const char       *image,
 ...
 */
gboolean
nautilus_link_impl_local_set_icon (const char *path, const char *icon_name)
{
 ...
 */
gboolean
nautilus_link_impl_local_set_link_uri (const char *path, const char *link_uri)
{
	return local_set_root_property (path,
					"link",
					link_uri,
...
gboolean
nautilus_link_impl_local_set_type (const char *path,
				   NautilusLinkType type)
{
	return local_set_root_property (path,
					"nautilus_link",
...
char *
nautilus_link_impl_local_get_additional_text (const char *path)
{
...
char *
nautilus_link_impl_local_get_link_uri (const char *path)
{
...
NautilusLinkType
nautilus_link_impl_local_get_link_type (const char *path)
{
 ...
 */
char *
nautilus_link_impl_get_link_uri_given_file_contents (const char *file_contents,
						     int file_size)
{
	xmlDoc *doc;
	char *property;
...
{
	return nautilus_link_impl_local_get_link_type (path) == NAUTILUS_LINK_MOUNT;
}

gboolean
nautilus_link_impl_local_is_home_link (const char *path)
{
	return nautilus_link_impl_local_get_link_type (path) == NAUTILUS_LINK_HOME;
}

gboolean
nautilus_link_impl_local_is_trash_link (const char *path)
{
	return nautilus_link_impl_local_get_link_type (path) == NAUTILUS_LINK_TRASH;
}


void
nautilus_link_impl_local_create_from_gnome_entry (GnomeDesktopEntry *entry, const char *dest_path, const GdkPoint *position)
{
	char *icon_name;
	...
	if (launch_string != NULL) {
		nautilus_link_impl_local_create (dest_path, entry->name, icon_name, 
