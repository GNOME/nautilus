...
/* Render a GdkPixbuf from source_point destination_area of a GdkDrawable. */
void                      nautilus_gdk_pixbuf_render_to_drawable           (const GdkPixbuf            *pixbuf,
...
/* Render a GdkPixbuf from source_point destination_area of another GdkPixbuf. */
void                      nautilus_gdk_pixbuf_render_to_pixbuf             (const GdkPixbuf            *pixbuf,
									    GdkPixbuf                  *destination_pixbuf,
									    const GdkPoint             *source_point,
									    const GdkRectangle         *destination_area);
...
/* Render a GdkPixbuf from source_point destination_area of another GdkPixbuf. */
void                      nautilus_gdk_pixbuf_render_to_pixbuf_alpha       (const GdkPixbuf            *pixbuf,
									    GdkPixbuf                  *destination_pixbuf,
									    const GdkRectangle         *destination_area,
...
gboolean                  nautilus_gdk_pixbuf_save_to_file                 (GdkPixbuf                  *pixbuf,
